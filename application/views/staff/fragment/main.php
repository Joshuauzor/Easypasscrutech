        ...
        <div class="main-content">
            ...
            <div class="container">
                ...
                <div class="page-header">
                    ...
                    <small class="">Welcome, <span class="text-primary"><?= $this->session->staff->firstname.' '.$this->session->staff->lastname ?></span></small>
                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex d-sm-block d-lg-flex align-items-end mb-3">
                                            <h3 class="mb-0 mr-2"><?= $dept_name ?></h3>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-3 pt-3">
                                            ...
                                            <div class="col border-right">
                                                <p class="mb-0">
                                                    <span class="fa fa-circle text-info mr-1"></span> Past Ques
                                                </p>
